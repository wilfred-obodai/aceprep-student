...
const styles = {
  ...
  examHeader:     { background: 'linear-gradient(135deg, #1A5276, #2E86AB)', padding: '20px 20px 16px' },
  ...
  optionCard:     { display: 'flex', alignItems: 'center', gap: 12, padding: 14, borderRadius: 10, marginBottom: 8, cursor: 'pointer', border: '1px solid #eee', borderStyle: 'solid' },
  ...
  resultContainer:{ padding: '40px 24px', maxWidth: 400, margin: '0 auto' },
